...
const CountryBanner = ({
  ...
  const allVideo = {
    au: "https://tracker.4friends.casino/video_australia",
    ca: "https://tracker.4friends.casino/video_newzealand",
    nz: "https://tracker.4friends.casino/video_canada",
  };
            ...
            <div className="one-brand" key={index}>
              <div>
                <a
                  id="hottestBonus"
                  target="_blank"
                  href={rowData["GoBig"] + newUrl + "L_spintasctic_Video"}
                >
